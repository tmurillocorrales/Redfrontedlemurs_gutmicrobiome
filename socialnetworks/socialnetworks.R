...
#Lea Prox contributed to these scripts.
...
#Calculate body contact aspect ####
#create matrix to store body contact time
bctime=matrix(0,length(names),length(names))
bctime=as.data.frame(bctime)
rownames(bctime)=names
colnames(bctime)=names
...
#Combine figures with indicator and social networks were created in cytoscape.